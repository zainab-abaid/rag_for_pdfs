...
def main():
    ...
    eval_out = os.getenv("RETRIEVAL_EVAL_OUTPUT_CSV") or os.getenv("retrieval_eval_output_csv")
    if not eval_out:
        raise SystemExit("ERROR: RETRIEVAL_EVAL_OUTPUT_CSV or retrieval_eval_output_csv environment variable is required.\n"
                        "Set it to the path where you want to save retrieval evaluation results (e.g., logs/retrieval_eval_log.csv).")
